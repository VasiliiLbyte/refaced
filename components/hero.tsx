...
const HERO_IMG_DESKTOP = assetPath('/hero-samurai-desktop.jpg')
      ...
      <section className="relative -mt-9 h-[100svh] w-full overflow-hidden bg-ink">
        ...
        <picture className="absolute inset-0 block h-full w-full">
          ...
          <img
            ...
            className="h-full w-full origin-center object-cover object-[center_38%] grayscale animate-kenburns"
